component accessors="true" {
	...
	property formatterService getter="false";
	property beanFactory getter="false";

	property string dataDir getter="false";
	...
	function convertDataPathToRelativeLink (inputPath) {
		var dataDir = replace(replace(expandPath(variables.dataDir), "\", "/", "all"), "/data", "");
